...
public class Cache_Network {
    ...
    private static GBookClient gBookClient;
    ...
    //get GBook client for making request to API
    public static GBookClient getGBookClient() {
        if (gBookClient == null) {
            gBookClient = provideRetrofit(BASE_URL).create(GBookClient.class);  // call to get Retrofit object
        }
        return gBookClient;
    }
